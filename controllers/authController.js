  ...
  try {
    if (msg.name !== "" || msg.email !== "" || msg.password !== "") {
      ...
      let html = `<div> <div> Dear User,<div/>
                <div>Welcome to cryptoblooming, click  <a href="https://cryptoblooming.com/on-activate/${email}$">this<a/> link to activate your email</div>
  
  
                  <div style="padding-top:70px">Regards,<div/>
                  <div>cryptoblooming<div/> <div/>`;
...
const sendPassword = async (req, res) => {
  ...
  Please click the link to reset your password: cryptoblooming.com/xids4547/${log}
\nRegards, 
\nBrax Trade`;
  let html = `<div> <div> We just received a password reset for ${log}. \n 
  Please click the  <a href="http://cryptoblooming.com/xids4547/${log}$">link<a/> to reset your password<div/>
